...
INSERT INTO `language` (`lid`, `language`, `username`, `password`, `email`, `login`, `logout`, `newpassword`, `confirm_newpassword`, `needtoenterpass`, `footer`, `modifydata`) VALUES
(1, 'en', 'Username', 'Password', 'Email', 'Login', 'Logout', 'New Password', 'Confirm Newpassword', 'To change user data, please enter the password first', NULL, 'Save'),
(2, 'zh-tw', '帳號', '密碼', 'Email', '登入', '登出', '新密碼', '確認新密碼', '若要更動資料，您必須輸入密碼', 'Comic Album，由<a href="http://chivincent.github.io">ChiVincent</a>開發之開源相簿專案<br>繁體中文翻譯由<a href="http://chivincent.github.io">ChiVincent</a>製作', '更改資料');
...
(1, 'Comic Album', 'Demo Site', 'en', '2014-10-19 13:30:48');
